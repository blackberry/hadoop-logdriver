...
package com.rim.logdriver.sawmill.mina;
...
public class TextLineDecoder implements ProtocolDecoder {
  ...
  /**
   * Returns the allowed maximum size of the line to be decoded. If the size of
  ...
  /**
   * Sets the allowed maximum size of the line to be decoded. If the size of the
   * line to be decoded exceeds this value, the decoder will throw a
   * {@link BufferDataException}. The default value is <tt>1024</tt> (1KB).
   */
   ...
   *         Project</a>
   * @version $Rev: 936203 $, $Date: 2010-04-21 10:49:20 +0200 (mer. 21 avril
   *          2010) $
   */
