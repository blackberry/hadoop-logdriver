...
chomp $LOGDRIVER_JAR;
my $LOGDRIVER_HDEPLOY = 'jar-with-dependencies/logdriver-with-dependencies.jar';
...
my $mr_cmd = "$HADOOP_JAR $LOGDRIVER_HOME/$LOGDRIVER_HDEPLOY "
        . "com.rim.logdriver.util.FastSearchByTime"
        . " " . $mr_opts
        . " " . escape($search_string)
        . " " . escape($dc)
        . " " . escape($service)
        . " " . escape($component)
        . " " . escape($start)
...
print STDERR "Searching for \"$search_string\"...\n";
